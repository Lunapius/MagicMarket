	...
	<div class="container">
		<div class="row">
			<div class="toolbar-ct-1">
				<p>
					<i class="fa fa-phone"></i> <span style="margin-right: 15px;">电话：4008-517-517</span><a
...
<div id="toolbar" style="background-color: #F0F0F0; width: 100%;">
	<div class="container">
		<div class="row">
			<div class="toolbar-ct-1">
				<p>
					<i class="fa fa-phone"></i> <span style="margin-right: 15px;">电话：4008-517-517</span>您好，<%=username%>
					&nbsp; &nbsp;<a href="modifyMember.jsp?username=<%= username%>">修改</a>&nbsp;&nbsp;
					|&nbsp;&nbsp;<a href="logout.jsp">退出</a>
				</p>
			</div>
			<div class="toolbar-ct-2">
				<a href="orderList.jsp?username=<%= username%>">我的订单</a>&nbsp;&nbsp; | &nbsp;&nbsp; <a
					href="">我的收藏</a>
			</div>
		</div>
	</div>
