						...
						<form id="member-registration" action="register_deal.jsp"
							...
							<fieldset>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<!-- 账户文本框 -->
										<input type="text" name="username" id="username" value="" placeholder="不得超过20字符或10个汉字"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="text" name="truename" id="jform_username"
											value="" class="validate-username required" size="38" placeholder="不得超过20字符或10个汉字"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="password" name="pwd" id="pwd" value=""
											autocomplete="off" class="validate-password required" placeholder="长度须在6~20字符内"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										<input type="password" name="pwd2" id="pwd2" value=""
											autocomplete="off" class="validate-password required"placeholder="与密码保持一致"
											size="38" maxlength="99" required="required"
											aria-required="true"><span class="star">&nbsp;*</span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										<!-- 联系电话文本框 -->
										<input type="text" name="tel" class="validate-email " id="tel"placeholder="11位电话号码"
								...
								<div class="form-group">
									...
									<div class="col-sm-8" style="clear: none;">
										<!-- 邮箱文本框 -->
										<input type="email" name="email" class="validate-email"placeholder="例：ILuvSoftware@mail.com"
											id="jform_email2" value="" size="38" aria-required="true">
									</div>
								</div>
								<div class="form-group">
									<div style="float: right; padding-right: 216px;">
										魔法集市<a href="agreement.html" style="color: #0885B1;">《使用条款》</a>
									</div>
								</div>
								<div class="form-group">
