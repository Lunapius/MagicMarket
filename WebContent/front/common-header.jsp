					...
					<div class="mr-megamenu animate slide" data-duration="400"
						...
						<ul class="nav navbar-nav level0">
							...
							<li itemprop="name" data-id="510" data-level="1"><a
								...
								href="goodsList.jsp?type=21" data-target="#">手办类</a></li>

							<li itemprop="name" data-id="510" data-level="1"><a
								id="wenyi" itemprop="url" class="" href="goodsList.jsp?type=23"
								data-target="#">漫画小说类</a></li>

							<li itemprop="name" data-id="510" data-level="1"><a
								id="jiaoyu" itemprop="url" class="" href="goodsList.jsp?type=1023"
								data-target="#">展会门票类</a></li>
							<li itemprop="name" data-id="510" data-level="1"><a
								id="shenghuo" itemprop="url" class=""
								href="goodsList.jsp?type=1024" data-target="#">周边类</a></li>
						</ul>
					</div>
